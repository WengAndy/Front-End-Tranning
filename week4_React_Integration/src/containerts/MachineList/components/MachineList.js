    ...
    return (
      <div className="tr">
        ...
        <div className="td-address">
          ...
          { item.address }
          {/* <input className="editMode input-address" type="text" name="address" /> */}
        </div>
        <div className="td-region">
          <div className="reviewMode td-region-content" />
          { item.region }
          {/* <input className="editMode input-region" type="text" name="region" /> */}
        </div>
        <div className="td">
          <button className="list-detail" data-toggle="modal" data-target="#ModalDialog">
        ...
        <div className="td">
          <div className="edit-icon">
            <button className="reviewMode list-edit">
              <i className="fas fa-pencil-alt" />
            </button>
            <button className="reviewMode list-del">
              <i className="far fa-trash-alt" />
            </button>
            <button className="editMode list-cancel">
              <i className="fas fa-times" />
            </button>
            <button className="editMode list-check">
